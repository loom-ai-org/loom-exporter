...
|---|---|---|---|---|---|
| `driver_inputs` | `DriverInputs` | statements | 0 | 5 | conformer-ctc, dac, encodec, f5-tts, funasr-paraformer, funasr-sensevoice, hf-causal-lm, hf-ctc-asr, hf-token-classifier, lfm2-modular, lfm2-monolithic, qwen3, qwen3-tts-tokenizer-12hz, snac |
...
| `export_constants` | `ExportConstants` | statements | 0 | 1 | dia, f5-tts, gigaam-rnnt, granite-speech, kokoro, matcha, parakeet-rnnt, parakeet-tdt, qwen3-asr, qwen3-tts, styletts2, supertonic, t5, vits, whisper |
| `raw_lua_driver` | `RawLuaDriver` | prelude, statements, postlude | 2 | 2 | *nobody* (see below) |
| `lua_fragment` | `LuaFragment` | prelude, statements | 4 | 4 | dia, f5-tts, gigaam-rnnt, granite-speech, kokoro, matcha, parakeet-rnnt, parakeet-tdt, qwen3-asr, qwen3-tts, styletts2, supertonic, t5, vits, whisper |
| `subgraph_call` | `SubgraphCallComponent` | statements | 2 | 9 | dia, encodec, f5-tts, funasr-paraformer, gigaam-rnnt, granite-speech, kokoro, matcha, parakeet-rnnt, parakeet-tdt, qwen3-asr, styletts2, supertonic, t5, vits, whisper |
| `recurrent_call` | `RecurrentCall` | statements | 1 | 8 | encodec |
| `flow_matching_sampler` | `FlowMatchingSampler` | prelude, statements | 0 | 11 | f5-tts, matcha, supertonic |
| `driver_return` | `DriverReturn` | statements | 0 | 1 | dac, dia, encodec, f5-tts, kokoro, matcha, qwen3-tts, qwen3-tts-tokenizer-12hz, snac, styletts2, supertonic, vits |
...
*Emits:* statements. *Used by:* conformer-ctc, dac, encodec, f5-tts, funasr-paraformer, funasr-sensevoice, hf-causal-lm, hf-ctc-asr, hf-token-classifier, lfm2-modular, lfm2-monolithic, qwen3, qwen3-tts-tokenizer-12hz, snac.
...
*Emits:* statements. *Used by:* conformer-ctc, funasr-sensevoice, hf-causal-lm, hf-ctc-asr, hf-token-classifier, lfm2-monolithic, qwen3.
...
*Emits:* statements. *Used by:* conformer-ctc, funasr-sensevoice, hf-ctc-asr.
...
*Emits:* statements. *Used by:* dia, f5-tts, gigaam-rnnt, granite-speech, kokoro, matcha, parakeet-rnnt, parakeet-tdt, qwen3-asr, qwen3-tts, styletts2, supertonic, t5, vits, whisper.
...
*Emits:* prelude, statements. *Used by:* dia, f5-tts, gigaam-rnnt, granite-speech, kokoro, matcha, parakeet-rnnt, parakeet-tdt, qwen3-asr, qwen3-tts, styletts2, supertonic, t5, vits, whisper.
...
*Emits:* statements. *Used by:* dia, encodec, f5-tts, funasr-paraformer, gigaam-rnnt, granite-speech, kokoro, matcha, parakeet-rnnt, parakeet-tdt, qwen3-asr, styletts2, supertonic, t5, vits, whisper.
...
*Emits:* prelude, statements. *Used by:* f5-tts, matcha, supertonic.
...
*Emits:* statements. *Used by:* dac, dia, encodec, f5-tts, kokoro, matcha, qwen3-tts, qwen3-tts-tokenizer-12hz, snac, styletts2, supertonic, vits.
