...
| 10 | **AR LM + neural codec TTS** | orpheus+SNAC, outetts+WavTokenizer, qwen3-tts ×4, moss-tts ×2, miotts, omnivoice, csm, dia, bark, zonos+dac, indextts, parler, vibevoice-tts ×2, lfm2-audio-tts | 16 | ~20 | **the codec decoder (family 11)** + a delay/RQ token-emission driver | **Dia and Qwen3-TTS shipped**, each with its codec. **MOSS-TTS**: its codec shipped 2026-09-25 (MOSS-Audio-Tokenizer-v2, loom.cpp ADR-049/050); its 4.55B LM half needs the workstation to export |
